...
import { Utilisateurs, SearchResult } from './utilisateurs.model';

import { tableData } from './data';

import { SortDirection } from './utilisateurs-sortable.directive';
 ...
 */
function sort(tables: Utilisateurs[], column: string, direction: string): Utilisateurs[] {
  if (direction === '') {
    return tables;
  } else {
 ...
 */
function matches(tables: Utilisateurs, term: string, pipe: PipeTransform) {
...
export class UtilisateursService {
  ...
  // tslint:disable-next-line: variable-name
  private _tables$ = new BehaviorSubject<Utilisateurs[]>([]);
  // tslint:disable-next-line: variable-name
